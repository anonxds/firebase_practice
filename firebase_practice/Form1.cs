...
namespace firebase_practice
{
    public partial class Form1 : Form
    {
        ...
        private async void grid()
        {
            ...
            while (validate == true)
            {
                ...
                try
                {
                    ...
                    FirebaseResponse resp2 = await client.GetAsync("Operaciones/" + i);
        ...
        private async void resultado_Click(object sender, EventArgs e)
        {
            ...
            SetResponse response = await client.SetAsync("Operaciones/" + Variables.id, Variables);
